        ...
        >
          <div className="w-full my-5">
            ...
            <Input
              ...
              placeholder="My Amazing Prompts"
              size="sm"
              variant="bordered"
            />
          </div>
          ...
          <div className="w-full my-5">
            ...
            <Textarea
              ...
              required
              placeholder="ChatGPT, Midjourney, DALL-E prompts, Writing assistance, Code generation..."
              className="col-span-12 md:col-span-6 md:mb-0"
            />
            <br />
            <Button
              className="mb-3 w-full bg-[#16c252] text-black h-[45px] hover:bg-[#14a844] transition-colors font-Inter font-[600]"
              type="submit"
              isLoading={loading}
              size="lg"
            >
