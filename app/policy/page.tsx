        ...
        <div className="w-[90%] md:w-[80%] xl:w-[70%] mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className={`${styles.heading} mb-4`}>
              Privacy <span className="text-[#64ff4c]">Policy</span>
            </h1>
          ...
          <div className="prose prose-invert max-w-none space-y-8">
            {/* Introduction */}
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-[#64ff4c]">1. Introduction</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-[#64ff4c]">2. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-[#64ff4c]">3. How We Use Your Data</h2>
            ...
            {/* Data Security */}
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-[#64ff4c]">4. Data Security</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            {/* Your Rights */}
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-[#64ff4c]">5. Your Rights</h2>
            ...
            {/* Cookies */}
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-[#64ff4c]">6. Cookies</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-[#64ff4c]">7. Third-Party Services</h2>
              <p className="text-gray-300 leading-relaxed">
            ...
            {/* Contact */}
            <section>
              <h2 className="text-2xl font-semibold mb-4 text-[#64ff4c]">8. Contact Us</h2>
              <p className="text-gray-300 leading-relaxed">
                If you have questions about this privacy policy or your data, please contact us at{' '}
                <a href="mailto:privacy@promptplace.com" className="text-[#64ff4c] hover:underline">
